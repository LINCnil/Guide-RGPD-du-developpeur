<p align="center"><img src="https://github.com/LINCnil/Guide-RGPD-du-developpeur/raw/master/templates/BANNIERE.JPG" alt="" width="100%" align="middle"></p>
...
* Une [version web sur le site de la CNIL](https://cnil.fr/developpeur) et dans [l’onglet « Releases »](https://github.com/LINCnil/Guide-RGPD-du-developpeur/releases) de ce dépôt (repository) ;
...
Pour fabriquer vous-même une version (release) de ce dépôt (repository), vous pouvez utiliser l’outil **Pandoc**. Cet outil vous permettra de convertir les fiches en un fichier bureautique ou bien un document HTML.

Vous pouvez retrouver les instructions pour installer cet outil [ici]( https://pandoc.org/installing.html) (en anglais).

* **Pour générer un fichier OpenDocument** :
```bash
pandoc -s --toc --toc-depth=1 -o Guide_RGPD_developpeur.odt [0-9][0-9]*.md
```
